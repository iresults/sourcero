var root = window;
Sourcero.Helpers = Sourcero.Helpers || {};

Sourcero.Helpers.CodeMirrorHelper = Ember.Object.extend({
	/**
	 * Mode
	 */
	codeMirrorMode: '',
	 ...
	 * Textarea
	 */
	codeTextarea: document.getElementById("editor"),
	...
	init: function () {
		...
		console.log(this.codeTextarea, document.getElementById("editor"));
